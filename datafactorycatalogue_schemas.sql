...
CREATE TABLE [history].[AzDataFactoryV2GlobalParametersDevelopment](
...
CREATE TABLE [history].[AzDataFactoryV2GlobalParametersQA](
	[GlobalParameterKey] [nvarchar](max) NULL,
	[GlobalParameterValue] [nvarchar](max) NULL,
	[HistoricalGlobalParameterValue] [nvarchar](max) NULL,
	[RecordCreationDate] [datetime] NULL,
...
CREATE TABLE [history].[AzDataFactoryV2GlobalParameterProduction](
	[GlobalParameterKey] [nvarchar](max) NULL,
	[GlobalParameterValue] [nvarchar](max) NULL,
	[HistoricalGlobalParameterValue] [nvarchar](max) NULL,
	[RecordCreationDate] [datetime] NULL,
